...
<!-- /头部 -->
	...
	<div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="javascript:;" onClick="travel_edit('新增线路','<?php echo U('travel/travel_edit');?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增线路</a>
            </span>
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tbody>
            	<?php if(is_array($travel_list)): $k = 0; $__LIST__ = $travel_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-c">
                    ...
                    <td><?php echo ($vo["travel_column"]); ?></td>
