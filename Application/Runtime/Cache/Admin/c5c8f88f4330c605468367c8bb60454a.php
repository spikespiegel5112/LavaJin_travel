...
<article class="page-container">
	<form action="<?php echo U('User/edit');?>" method="post"class="form form-horizontal" id="form-admin-add">
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($user["realname"]); ?>" placeholder="" id="rolename" name="rolename">
		</div>
	</div>
<!-- 	<div class="row cl">
