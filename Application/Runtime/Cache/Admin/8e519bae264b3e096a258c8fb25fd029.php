...
<!-- /头部 -->
	...
	<div class="page-container">
        <form action="<?php echo U('add');?>" method="post" class="form form-horizontal" id="form-article-add">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品标题：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="" name="travel_title">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">简略标题：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="" name="travel_short_title">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                    <select name="travel_column" class="select">
                    	<option value="">-----</option>
                        <option value="0">当下必玩</option>
                        <option value="1">深度体验</option>
                    </select>
                    </span> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="0" placeholder="数字越大越靠前" id="" name="travel_sort">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                    <div class="check-box">
                        <input type="checkbox" id="checkbox-1" value="1" name="travel_allow_comment">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="travel_original_price" id="" placeholder="" value="" class="input-text" style="width:20%">
                    元</div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">售卖价：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="travel_price" id="" placeholder="" value="" class="input-text" style="width:20%">
                    元</div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">商品亮点：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="travel_highlights" cols="" rows="" class="textarea"  placeholder="多个亮点用英文分号隔开" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,400)"></textarea>
