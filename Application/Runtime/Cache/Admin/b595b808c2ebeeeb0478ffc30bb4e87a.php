...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo U('index');?>">西藏旅游</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="<?php echo U('index');?>">西藏旅游</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v1.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dd>
			...
			<dd>
				<ul>
					<li><a data-href="<<?php echo U('Member/index');?>>" data-title="会员列表" href="javascript:;">酒店列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-jipiao">
			...
			<dd>
				<ul>
					<li><a data-href="<<?php echo U('Member/index');?>>" data-title="机票列表" href="javascript:;">机票列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/" data-title="反馈建议" href="javascipt:;">反馈建议</a> </li>
				</ul>
			</dd>
		</dl>
	</div>
