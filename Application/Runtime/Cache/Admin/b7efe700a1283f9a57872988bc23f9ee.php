...
<!-- /头部 -->
	...
	<div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="javascript:;" onClick="tese_edit('新增<?php echo ($tese_name); ?>','<?php echo U('tese/tese_edit',array('category'=>$tese_category));?>','1600','850')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增<?php echo ($tese_name); ?></a>
            </span>
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tbody>
            	<?php if(is_array($tese_list)): $k = 0; $__LIST__ = $tese_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-c">
                    ...
                    <td><?php echo ($vo["tese_title"]); ?></td>
                    <td><?php echo ($vo["tese_original_price"]); ?></td>
                    <td><?php echo ($vo["tese_price"]); ?></td>               
                    <td class="td-status">
