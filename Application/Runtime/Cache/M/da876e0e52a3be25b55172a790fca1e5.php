	...
	<div class='main_container'>
		...
		<div class='common_block_wrapper'>
			<div class='product_detailtitle_wrapper'>
				<h2><?php echo ($tese["tese_title"]); ?></h2>
				<p><?php echo ($tese["tese_short_title"]); ?></p>
			</div>
			<div class='product_detailprice_wrapper'>
				<label class='peoples'><span class='iconfont'></span>68人参加过</label>
				<div class='price'>
					<span>￥<?php echo ($tese["tese_price"]); ?></span>
					<label>￥<?php echo ($tese["tese_original_price"]); ?></label>
				</div>
			</div>
		...
		<div class='common_block_wrapper'>
			...
			<div class='product_detailhighlight_wrapper'>
				<ul>
					<?php if(is_array($tese_highlights)): $i = 0; $__LIST__ = $tese_highlights;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<span></span>
