...
<body>
	<div class='main_container'>
		<div class="common_header_wrapper">
            <a class="left_btn back_btn" href="<?php echo U('User/index');?>">
                <span class="iconfont icon-backward2"></span>
            </a>
            <p>关于</p>
        </div>
        <div class='user_about_wrapper'>
        	<p>
        		一直专注于品质|轻旅行商城的打造，在自助旅游这个不断增长的细分领域，除了提供体验性自助游产品，也与众多知名酒店，景区，户外品牌深度合作，后续会不断发起众多特色特别的体验活动。
        	</p>
        </div>
	</div>
</body>
