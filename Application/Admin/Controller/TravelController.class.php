...
class TravelController extends PublicController {
	...
	public function travel_edit(){
		...
		if($id){
			...
			$imageList = getImageList("./Uploads/travel/$id",$travel['travel_mainimg']);
		...
		$index_category_list = M('index_category')->select();
		
		$this->assign('category_list',$category_list);		
		$this->assign('index_category_list',$index_category_list);
		$this->display();
	}
	 ...
	 * 图片上传
	 */
	public function category_uploader(){
		$id = I('get.id');
		$tmpFolder = I('get.tmpFolder');
		$category_mainimg = I('get.category_mainimg');
		if(!empty($category_mainimg)){
			unlink($category_mainimg);
		}
